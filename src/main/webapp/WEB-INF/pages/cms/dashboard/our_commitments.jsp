		...
		<div class="box box-info">
			...
			<div class="box-body">
				<div class="col-xs-6" style="padding: 5px; margin: 0 0 0 5px;">
					<!-- Button ADD  -->
					<a
						href="/dashboard/content/commitment/add"
									...
									<tr>
										...
										<td class="td-action">
											<ul class="tools list-unstyled table-menu">
												<li><a
													href="/dashboard/content/commitment/edit?id=${ourCommitment.id }"
													class="edit_button"><i class="fa fa-pencil"></i> Edit</a></li>
												<li><a
													href="/dashboard/content/commitment/delete?id=${ourCommitment.id }"
