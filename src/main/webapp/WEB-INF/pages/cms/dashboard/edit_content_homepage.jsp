	...
	<div class="page-content">
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li><i class="fa fa-angle-right"></i> Edit Content Homepage</li>
			</ul>
		</div>
		<h3 class="page-title">Content Homepage</h3>
		<div class="row">
			<div class="col-lg-12">
				<div class="flexigrid crud-form box"
					...
					<div class="box-header with-border">
						<h3 class="box-title">
							<i class="fa fa-plus-circle fa-fw"></i> Edit Content Homepage
						</h3>
					</div>
					...
					<div id="main-table-box" class="box-body">
						<div class="col-lg-8">
							<form:form
								action="/dashboard/content/homepage/edit"
