			...
			<div class="col-lg-12">
				<div class="flexigrid crud-form box"
					...
					<div id="main-table-box" class="box-body">
						<div class="col-lg-8">
							<form:form
								action="${pageContext.request.contextPath}/dashboard/content/culture/edit"
								...
								<a
									...
									id="cancel-button" class="btn btn-default">Cancel</a>
						...
						<div class="col-lg-4">
							<form
								action="${pageContext.request.contextPath}/uploadCultureImage"
								...
								<div class="row" id="no_po_field_box">
									...
									<div class="col-lg-10" id="no_po_input_box">
										<input type="file" name="file" accept="image/x-png,image/jpeg"
											path="multipartFile" /> <input type="hidden" name="id"
											value="${id }" />
									</div>
								</div>
								<div class="row">
									<div class="form-display-as-box col-lg-2 control-label"
										id="no_po_display_as_box"></div>
									<div class="col-lg-10">
