...
INSERT INTO `content_howtowork` (`id`, `title`, `content`, `icon`, `icon_color`, `process`) VALUES
	(1, 'Sample', '<p>Calon customers dapat mengirimkan deskripsi barang dan bahan yang akan dipesan melalui info@mikatama-unika.com.</p>', 'icon-adjust', 'red', 'customer'),
...
-- Dumping data for table mikatama.order_product: ~13 rows (approximately)
/*!40000 ALTER TABLE `order_product` DISABLE KEYS */;
INSERT INTO `order_product` (`id`, `product_id`, `name`, `address`, `email`, `phone`, `total`, `imageName`, `updateBy`, `status`) VALUES
	(1, 1, 'test23', 'test23', 'test23@test.com', '80900023', 3, 'test23.jpg', '', 0),
	(2, 1, 'test23', 'test23', 'test23@test.com', '80900023', 3, 'test23.jpg', '', 0),
	(3, 1, 'test23', 'test23', 'test23@test.com', '80900023', 3, 'test23.jpg', '', 0),
	(4, 1, 'test23', 'test23', 'test23@test.com', '80900023', 3, 'test23.jpg', '', 0),
	(5, 2, 'testing upsizeee', 'Rengasdengklok, Karawang', 'vim.dikad@xl.co.id', '098848484', 1, '5_XL Diamater.png', NULL, 0),
	(6, 1, 'testing upsizeee', 'Rengasdengklok, Karawang', 'vim.dikad@xl.co.id', '0889898989', 1, '6_dian_prio_pass.png', NULL, 0),
	(7, 2, 'test percobaan', 'percobaan', 'test@test.com', '081887387', 1, '7_dian_prio_pass.png', NULL, 0),
	(8, 2, 'percobaan', 'perbaikan', 'test@test.com', '080808090', 1, '8_dian_prio_pass.png', NULL, 0),
	(9, 2, 'tezt', 'jajal dlu yaaa', 'test@test.com', '0892829289', 1, '9_dian_prio_pass.png', NULL, 0),
	(10, 1, 'test coy', 'percobaan', 'percobaa@tes.com', '087877287', 1, '10_prio pass.png', NULL, 0),
	(11, 2, 'test jajal dulu', 'perum beee', 'test@test.com', '0817672627', 1, '11_prio pass.png', NULL, 0),
	(12, 2, 'jajal', 'jajal', 'jajal@test.com', '989898', 1, '12_prio pass.png', NULL, 0),
	(13, 2, 'test empat', 'test', 'test@test.com', '08892882', 4, '13_Capture.JPG', NULL, 0),
	(14, 5, 'coba product lima', 'test', 'test@test.com', '08282728', 5, '14_dian_prio_pass.png', NULL, 0),
	(15, 5, 'test', 'coba', 'test@coba.com', '0887878', 5, '15_XL Diamater.png', NULL, 0);
...
INSERT INTO `product` (`id`, `product_name`, `product_desc`, `price`, `image`, `stock`, `status`) VALUES
	...
	(2, 'Plakat Mikatama', 'Produk Unggulan yang sangat diminati', '75000', 'plakat.jpg', 66, 1),
	...
	(5, 'Tissue Box', 'Produk hasil kerjasama dengan PT Surya Madistrindo yang digunakan sebagai tempat tissue', '25000', 'tissue_box.jpg', 0, 1);
...
-- Dumping data for table mikatama.product_image: ~5 rows (approximately)
